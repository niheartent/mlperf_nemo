...
export JOB_DIR="/data/share/C4_llama3_8b/mlperf_nemo/logs"
...
export PREPROCESSED_PATH="1 /data/share/C4_llama3_8b/llama3_1_8b_preprocessed_c4_dataset/c4-train.en_6"
export MERGED_C4_PATH="/data/share/C4_llama3_8b/merged_data_for_train"
# Dataset: Numpy index working directory, contains shuffled dataset
# This path must be able to hold >400GB data
export TMP_NPY_INDEX="/data/share/C4_llama3_8b/npy_indices"
# Dataset: Tokenizer path
# This corresponds to the TOKENIZER_PATH in README section 3's tokenizer download part
export TOKENIZER_PATH="/data/share/C4_llama3_8b/llama3_1_8b_tokenizer"
...
export MAX_STEPS=1200 # Fixed max_steps=1200000 in pretrain_llama31.py  
